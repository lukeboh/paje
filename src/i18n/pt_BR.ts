  ...
  tui: {
    tree: {
      ...
      bulkCreateConfirmMessage:
        "{{branch}} não existe em {{count}} dos repositórios marcados. Enter: cria e envia ao remoto nesses também | Esc: troca só onde a branch já existe, pula o resto",
      ...
      bulkCreated: "{{label}}: branch criada e enviada ao remoto.",
