const ptBR = {
  ...
  tui: {
    tree: {
      ...
      bulkNoSelection: "Nenhum repositório marcado. Use Espaço para marcar antes de usar Ctrl+K/Ctrl+R.",
      bulkCheckoutTitle: "Checkout em massa",
      bulkCheckoutLabel: "Nome da branch",
      bulkCreateConfirmTitle: "Branch ausente em alguns repositórios",
      bulkCreateConfirmMessage:
        "{{branch}} não existe em {{count}} dos repositórios marcados. Enter: cria localmente nesses também (sem enviar ao remoto — envie manualmente se quiser) | Esc: troca só onde a branch já existe, pula o resto",
      bulkReturnConfirmTitle: "Voltar à branch padrão",
      bulkReturnConfirmMessage: "Voltar {{count}} repositório(s) marcado(s) para a branch padrão de cada um?",
      bulkCheckedOut: "{{label}}: branch trocada.",
      bulkCreated: "{{label}}: branch criada localmente (não enviada ao remoto).",
  ...
  branchModal: {
    ...
    hintRename: "Digite o novo nome e Enter para renomear | Esc para cancelar",
    empty: "Nenhuma branch local encontrada.",
    createOption: "+ Criar nova branch",
    renameOption: "✎ Renomear branch atual",
    newBranchLabel: "Nome da nova branch",
    newNameLabel: "Novo nome da branch",
    ...
    renameSuccess: "Branch renomeada de {{oldName}} para {{newName}}.",
    renameRemoteDeleteWarning: "Branch renomeada para {{newName}}, mas não foi possível remover {{oldName}} do remoto — remova manualmente se necessário.",
  },
  excludeModal: {
