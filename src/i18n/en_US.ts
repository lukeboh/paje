  ...
  tui: {
    tree: {
      ...
      bulkCreateConfirmMessage:
        "{{branch}} doesn't exist in {{count}} of the marked repositories. Enter: create and push it there too | Esc: only switch where the branch already exists, skip the rest",
      ...
      bulkCreated: "{{label}}: branch created and pushed to the remote.",
